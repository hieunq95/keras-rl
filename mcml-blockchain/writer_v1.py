...
class MCMLWriter():
    ...
    def __init__(self, workbook):
        ...
        self.worksheet1.write('H1', 'Action_penalty', bold)
        self.worksheet1.write('I1', 'Mempool_state', bold)
    ...
    def general_write(self, logs, episode):
        ...
        self.worksheet1.write(episode, 7, info.get('action_penalty'))
        self.worksheet1.write(episode, 8, info.get('mempool_state'))
